...
なぜこのような仕様にしたかというと、"position:fixed" や "z-index" を駆使してあれこれするのも良い方法だと思いますが、如何せん不具合が多く実装の難易度が高くなりがちです。  
...
モーダル部分と、それ以外の通常コンテンツ（モーダル非表示時に表示されている）をそれぞれ同階層で”modal_classname”と”page_classname”にクラスを分けてください。
